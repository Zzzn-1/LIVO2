...
public:
  ...
  cv::Mat img_setic_;        //!< Image of the frame with semantic information.
  cv::Mat img_setic_color_; //!< (Optional) Original color semantic image, if available.
  Features fts_;             //!< List of features in the image.
  bool has_setic_ = false;   //!< 标记本帧是否有语义图像
  ...
  // void initFrame_setic(const cv::Mat &img_setic);
  void initFrame_setic(const cv::Mat &img_setic);
  ...
  inline bool hasSetic() const { return has_setic_; }
};
